...
; *** Common wizard text
ClickNext=Click Install D2RM to continue, or Cancel to exit Setup.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=You're about to install DOTA 2 Replay Manager!
WelcomeLabel2=This will install [name/ver] created by Pavel Yarmak on your computer.%n%nKeep in mind that DOTA 2 Replay Manager is in Beta and I make no guarantees, so use it at your own risk.
